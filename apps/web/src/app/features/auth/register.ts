...
import { ZardToggleGroupItem, ZardButtonComponent, ZardCardComponent, UiField, ZardInputDirective, ZardToggleGroupComponent } from '@cooklog/ui';

@Component({
  selector: 'app-register',
  imports: [ReactiveFormsModule, RouterLink, ZardButtonComponent, ZardCardComponent, UiField, ZardInputDirective, ZardToggleGroupComponent],
    ...
    <z-card>
      ...
      <form [formGroup]="form" (ngSubmit)="submit()" class="space-y-4" novalidate>
        <div class="space-y-1.5">
          ...
          <z-toggle-group zMode="single" zType="outline"
            zLabel="Role"
            [items]="roles"
            [value]="role()"
        ...
        <ui-field label="Name" for="name" [error]="fieldError('name')">
          <input z-input id="name" autocomplete="name" formControlName="name" />
        </ui-field>
        ...
        <ui-field label="Password" for="password" [error]="fieldError('password')">
          <input z-input id="password" type="password" autocomplete="new-password" formControlName="password" />
        </ui-field>
