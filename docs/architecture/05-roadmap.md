...
| # | Milestone | Outcome |
| --- | --- | --- |
| M0 | Environment | pnpm/corepack, Supabase CLI + Docker local stack, repo scaffold, CI lint/test |
...
| M7 | ~~Native~~ | **Dropped** — CookLog is web-only; the Tauri desktop/mobile shell was removed (decisions D23) |
| M8 | Hardening & release | Playwright e2e, a11y audit (keyboard + screen-reader basics already landed: skip link, `aria-current`, menu/radiogroup keyboard contracts, route focus), performance, staging → prod Supabase, web deploy |
