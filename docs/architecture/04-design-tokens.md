...
- **Shape and type.** `--radius: 0.75rem` (`rounded-lg`), `rounded-xl` = +4px. Geist Sans/Mono self-hosted via Fontsource (works offline in Tauri). KDS sizes `text-kds-md|lg|xl` for the cook's docket.
